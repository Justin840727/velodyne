...
namespace velodyne_rawdata
{
  ...
  public:
    ...
    void unpack(const velodyne_msgs::VelodynePacket &pkt, VPointCloud &pc, VPointCloud &pc_one);
  ...
  private:
    ...
    void unpack_vlp16(const velodyne_msgs::VelodynePacket &pkt, VPointCloud &pc, VPointCloud &pc_one);
